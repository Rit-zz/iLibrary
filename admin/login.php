...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err)){
        ...
        $sql = "SELECT id, username, password FROM ausers WHERE username = ?";
    ...
    <div class="wrapper fadeInDown container">
        <div id="formContent" class="container">
            <div class="fadeIn first">
                <h2>Welcome to iLibrary Admin Page</h2>
            </div>
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                ...
                <div class="form-group">
                    <input type="submit" class="btn btn-primary fadeIn third" value="Login">
                </div>
