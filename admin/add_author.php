...
<head>
  ...
  <title>iLibrary | Add Author</title>
                ...
                <form role="form" method="post">
                    <div class="active-cyan-4 mb-4">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="author" placeholder="Add New Author" aria-label="Search" required>
                        </div>
                        <button type="submit" name="create" class="btn btn-primary">Add Author</button>
                    </div>
                </form>                
            </div>
            <div class="col-lg-3 col-md-0"></div>
